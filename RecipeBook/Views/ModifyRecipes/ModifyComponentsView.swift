...
//  RecipeBook
//
//  Created by 𝒴𝑜𝓊𝓁𝒾𝒶 𝒯𝒾𝑔𝓇𝒶𝓃𝓎𝒶𝓃 on 28.02.26.
//  Generic structure to modify ingredients and direction
...
// Using generic DestinationView that conforms to ModifyComponentView to display appropriate view for the component
// Ensure that both components are the same using a generic where clause
